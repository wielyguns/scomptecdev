					...
					<div class="row">
						<div class="col-md-8">
							...
							<div class="form-group row">
								...
								<div class="col-8">
									<div class="custom-control custom-radio custom-control-inline">
										<input class="custom-control-input" id="status1" type="radio" name="status" value="Full Time" checked="true">
										<label class="custom-control-label" for="status1">Full Time</label>
									</div>
									<div class="custom-control custom-radio custom-control-inline">
										<input class="custom-control-input" id="status2" type="radio" name="status" value="Part Time">
								...
								<div class="col-8">
									...
									@if($errors->has('tgl_lahir'))
										<div class="input-group invalid datepicker">
											<input class="form-control" id="tgl_lahir" name="tgl_lahir" type="text" autocomplete="off" value="" />
							...
							<div class="form-group row">
								...
								<div class="col-8">
									<div class="input-group datepicker">
										<input class="form-control" id="tgl_bergabung" name="tgl_bergabung" type="text" autocomplete="off" />
										<div class="input-group-append">
