					...
					<div class="row">
						<div class="col-md-8">
							...
							<div class="form-group row">
								...
								<div class="col-8">
									<input class="form-control" type="text" name="biaya_pendaftaran" value="{{ old('biaya_pendaftaran') }}">
							...
							<div class="form-group row">
								...
								<div class="col-8">
									<input class="form-control" type="text" name="biaya_reguler" value="{{ old('biaya_reguler') }}">
							...
							<div class="form-group row">
								...
								<div class="col-8">
									<input class="form-control" type="text" name="biaya_private" value="{{ old('biaya_private') }}">
